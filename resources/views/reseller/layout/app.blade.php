...
<body class="md-skin">
<div id="wrapper">
    @include('reseller.layout.sidebar')
    @yield('content')
    @include('reseller.layout.right_sidebar')
</div>

<!-- Mainly scripts -->
@include('reseller.layout.script')
@yield('script')
<!-- Flot -->
...
<!-- EayPIE -->
<script src="{{asset('/master/')}}/js/plugins/easypiechart/jquery.easypiechart.js"></script>
...
<!-- Mirrored from webapplayers.com/inspinia_admin-v2.9.4/md_skin/dashboard_2.html by HTTrack Website Copier/3.x [XR&CO'2014], Thu, 14 Sep 2023 17:39:24 GMT -->
</html>
