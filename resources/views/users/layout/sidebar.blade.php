        ...
        <ul class="nav metismenu" id="side-menu">
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{route('recipients.create')}}">Add New</a></li>
                    <li><a href="{{route('recipients.list')}}">List</a></li>
            ...
            <li>
                ...
                <ul class="nav nav-second-level collapse">
                    <li><a href="{{route('messages.create')}}">Create</a></li>
                    <li><a href="{{route('messages.list')}}">List</a></li>
