                        ...
                        <div class="ibox-content">
                            <div class="row">
                                <div class="col-sm-12 b-r">
                                    ...
                                    @endif
                                    <form role="form" method="post" action="{{route('accounts.update',$edit['id'])}}">
                                        @csrf
                                        @if ($errors->any())
                                        ...
                                        <div class="form-group">
                                            <label>
                                                <input type="checkbox" name="status" value="1" class="i-checks" {{($edit['status']==1)?'checked':''}}> Active
                                            </label>
                                        </div>
                                        <div>
