@extends('master.app')
                            ...
                            <div class="ibox-content">
                                <div class="row">
                                    <div class="col-sm-12 b-r">
                                        ...
                                        @endif
                                        <form role="form" method="post" action="{{route('users.updateUser',$user['id'])}}">
                                            @csrf
                                            @if ($errors->any())
                                            ...
                                            <div class="form-group end_user ">
                                                ...
                                                <input type="text" name="emerg_contact_name" placeholder="Enter emergency contact name" value="{{old('emerg_contact_name',$user['emerg_contact_name'])}}"  class="form-control">
                                            </div>
                                            <div class="form-group end_user ">
                                                <label>Emergency Phone</label>
                                                <input type="text" name="emerg_contact" placeholder="Enter emergency phone number" value="{{old('emerg_contact',$user['emerg_contact'])}}"  class="form-control">
                                            </div>
                                            <div class="form-group end_user ">
                                                <label>Emergency Contact Mail</label>
                                                <input type="email" name="emerg_contact_mail" placeholder="Enter emergency contact mail" value="{{old('emerg_contact_mail',$user['emerg_contact_mail'])}}"  class="form-control">
                                            </div>
                                            <div class="form-group ">
                                                <label>Street</label>
                                            ...
                                            <div class="form-group end_user ">
                                                ...
                                                <input type="text" name="kin_name" placeholder="Enter next of kin" value="{{old('kin_name',$user['kin_name'])}}"  class="form-control">
                                            </div>
                                            <div class="form-group end_user ">
                                                <label>Next Of Kin Contact Number</label>
                                                <input type="text" name="kin_contact_number" placeholder="Enter next of kin contact number" value="{{old('kin_contact_number',$user['kin_contact_number'])}}"  class="form-control">
                                            </div>
                                            <div class="form-group ">
                                                <label>Note</label>
    ...
    @section('script')
        ...
        @endphp
        <script>changeUser('reseller');</script>
        @php
        }
